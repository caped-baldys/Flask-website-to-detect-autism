...
def index():
    ...
    #     if request.form["loginName"] == 'admin@gmail.com':

    #         if request.form["loginPassword"] == 'admin':
...
def forms():
    if request.method == 'POST':
        ...
        print(mcq, "\n", items)
        return redirect(url_for('result',rf=pred_randomforest(mcq,items['Age'],items['Sex']), lr=logistic_reg(mcq,items['Age'],items['Sex'])))
